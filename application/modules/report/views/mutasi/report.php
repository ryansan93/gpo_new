...
<div class="col-xs-12 no-padding" style="margin-top: 10px;">
	<button type="button" class="btn btn-default pull-right" onclick="mutasi.exportExcel()"><label class="control-lable" style="margin-bottom: 0px;"><i class="fa fa-file-excel-o"></i> Export Excel</label></button>
</div>