...
<div class="modal-body body">
	<div class="row">
			...
			<table class="table no-border" style="margin-bottom: 0px;">
				<tbody>
					<tr>
						...
						<td class="col-sm-10">
							<input type="text" class="col-sm-8 form-control nama uppercase" placeholder="Nama" data-required="1" value="<?php echo $data['nama']; ?>">
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="col-sm-12 no-padding" style="padding-left: 8px; padding-right: 8px;">
			<hr>
			<button type="button" class="btn btn-primary pull-right" onclick="im.edit(this)" data-id="<?php echo $data['id']; ?>">
