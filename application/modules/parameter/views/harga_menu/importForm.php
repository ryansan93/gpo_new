		...
		<div class="col-xs-12 detailed no-padding">
			<form role="form" class="form-horizontal">
                <div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
                    ...
                    <div class="col-xs-9 no-padding" style="padding-top: 2px;">
                        ...
                        <label class="" style="margin-bottom: 0px;">
                            <input style="display: none;" placeholder="Dokumen" class="file_lampiran no-check" type="file" onchange="hm.showNameFile(this)" data-name="name" data-allowtypes="xlsx" data-required="1">
				...
				<div class="col-xs-12 no-padding text-right">  
                    <button type="button" class="btn btn-default" onclick="window.open('parameter/HargaMenu/downloadTemplate')"><i class="fa fa-download"></i> Download Template</button>
                    |
                    <button type="button" class="btn btn-primary" onclick="hm.import()"><i class="fa fa-save"></i> Import</button>
				</div>
			</form>
		</div>
	</div>
