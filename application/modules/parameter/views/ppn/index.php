	...
	<div class="col-lg-12 detailed">
		...
		<div class="col-lg-4 action no-padding">
			<?php if ( $akses['a_submit'] == 1 ) { ?>
				<button id="btn-add" type="button" data-href="action" class="btn btn-primary cursor-p pull-right" title="ADD" onclick="ppn.modalAddForm(this)"> 
					...
					<?php if ( !empty($data) ): ?>
						<?php foreach ($data as $k_data => $v_data): ?>
							<tr class="search">
								...
								<td class="text-right">
									<button class="col-sm-12 btn btn-danger" data-id="<?php echo $v_data['id']; ?>" onclick="ppn.delete(this)"><i class="fa fa-times"></i></button>
								</td>
							</tr>
						<?php endforeach ?>
					<?php else: ?>
