			...
			<table class="table no-border" style="margin-bottom: 0px;">
				<tbody>
					...
					<tr>
						...
						<td class="col-sm-10">
							<input type="text" class="col-sm-6 form-control coa uppercase" placeholder="COA (MAX:50)" data-required="1" maxlength="50">
						</td>
					</tr>
					<tr>
						<td class="col-sm-2">				
						...
						<td class="col-sm-10">
							<textarea class="form-control ket_coa" data-required="1" placeholder="KETERANGAN COA (MAX:250)" maxlength="250"></textarea>
						</td>
					</tr>
				</tbody>
			</table>
