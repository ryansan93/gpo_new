...
<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
	<button type="button" class="col-xs-12 btn btn-primary pull-right tampilkan_riwayat" onclick="pp.getLists(this)"><i class="fa fa-search"></i> Tampilkan</button>
</div>

<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
	<button type="button" class="col-xs-12 btn btn-primary pull-right" onclick="pp.changeTabActive(this)" data-href="action" data-edit=""><i class="fa fa-plus"></i> ADD</button>
</div>
		...
		<table class="table table-bordered tbl_riwayat">
			<thead>
				<tr>
					...
					<th class="col-xs-2">Jenis Pembayaran</th>
					<th class="col-xs-2">Total Tagihan</th>
					<th class="col-xs-2">Total Bayar</th>
